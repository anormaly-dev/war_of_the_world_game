class SceneA extends Phaser.Scene {
 ...
 preload() {
    ...
    this.load.image('sky', 'assets/BackgroundA.jpg');
    this.load.image('smallground', 'assets/smallground.png');
    this.load.image('star', 'assets/alexFinal2.png');
    this.load.image('prof', 'assets/proff.png');
    this.load.image('mainground', 'assets/platformMain.png');
    this.load.image('brickx1', "assets/groundx1.png")
    this.load.image('brickx2', "assets/groundx2.png")
...
createLayout(){
    ...
    platforms.create(400, 568, 'brickx1').setScale(0.5).refreshBody();
    platforms.create(660, 1100, 'mainground').setScale(0.5).refreshBody();
    platforms.create(1200,1100, 'smallground').setScale(0.5).refreshBody();;
    platforms.create(800,980, 'smallground').setScale(0.5).refreshBody();;
    platforms.create(200,880, 'smallground').setScale(0.5).refreshBody();;
    platforms.create(400,700, 'smallground').setScale(0.5).refreshBody();;
    platforms.create(20,550, 'smallground').setScale(0.5).refreshBody();;
    platforms.create(600, 400, 'smallground').setScale(0.5).refreshBody();;
    platforms.create(20, 250, 'brickx1').setScale(0.5).refreshBody();;
    ...
    platforms.create(170, 320, 'brickx2').setScale(0.5).refreshBody();;
    platforms.create(1150, 720, 'brickx1').setScale(0.5).refreshBody();;
